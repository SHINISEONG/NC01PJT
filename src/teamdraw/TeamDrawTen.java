...
public class TeamDrawTen {
	...
	public TeamDrawTen() {
		totalPeopleArray.addAll(
				Arrays.asList("김미형","김석찬", "김성구", "김양수", "김영훈", "김태희", "박강락", "박성원", "박은진", "박주현", "소재연", "송영준", "송용범",
						"신희성", "유정호", "윤예슬", "이동욱", "이승현", "이재익", "이현석", "임철", "전유빈", "전지창", "정종현", "최성락"));
		leaderArray.addAll(Arrays.asList(" "));
		subLeaderArray.addAll(Arrays.asList("김성구","박주현","소재연","신희성","유정호","윤예슬","이동욱","이승현","이현석","최성락"));
	}
...
*/
	...
	public void printTeam() throws Exception {
		...
		System.out.println("\n--------------------------------------------------------------------------------------");
		System.out.println("\t\t\t\t*JAVA에 익숙한 사람들*\t\t\t");
